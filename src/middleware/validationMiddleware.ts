...
const validateFileUpload = (value: any, body: any, req: any): boolean => {
...
export interface ValidationRule {
  ...
  max?: number;
  enum?: string[];
  customValidation?: (value: any, body?: any, req?: any) => boolean;
...
export const couponValidationRulesForUpdate: ValidationRule[] = [
...
export const updateUserValidationRules: ValidationRule[] = [
...
export const updateMeValidationRules: ValidationRule[] = [
...
export const resetPasswordValidationRules: ValidationRule[] = [
...
export const updateOrderStatusValidationRules: ValidationRule[] = [
...
export const updatePaymentStatusValidationRules: ValidationRule[] = [
...
export const createOrderValidationRules: ValidationRule[] = [
...
export const orderItemValidationRules: ValidationRule[] = [
...
export const shippingAddressValidationRules: ValidationRule[] = [
...
export const createReviewValidationRules: ValidationRule[] = [
...
export const updateReviewValidationRules: ValidationRule[] = [
...
export const addToWishlistValidationRules: ValidationRule[] = [
  { field: 'productId', required: true, type: 'string', minLength: 1, customMessage: 'Product ID is required' },
];

// Payment validation rules
export const createPaymentValidationRules: ValidationRule[] = [
...
export const verifyPaymentValidationRules: ValidationRule[] = [
...
export const couponValidationRules: ValidationRule[] = [
...
export const useCouponValidationRules: ValidationRule[] = [
...
export const updateProfileValidationRules: ValidationRule[] = [
...
export const forgotPasswordValidationRules: ValidationRule[] = [
  { field: 'email', required: true, type: 'string', minLength: 5, maxLength: 100, customValidation: (value) => isValidEmail(value), customMessage: 'Please provide a valid email address' },
];

// Product search/filter validation rules
export const productSearchValidationRules: ValidationRule[] = [
...
export const contactFormValidationRules: ValidationRule[] = [
...
export const contactUpdateValidationRules: ValidationRule[] = [
...
export const contactAssignmentValidationRules: ValidationRule[] = [
...
export const bulkContactValidationRules: ValidationRule[] = [
...
export const validateContactForm = validateRequestBody(contactFormValidationRules); 